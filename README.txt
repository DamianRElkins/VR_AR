The render.py file has been altered according to coursework tasks. In order to run a sequence the complimentary_filter function can be used. It is passed
a list of objects, the IMU data, and boolean values indicating whether it should use accelerometer readings, magnetometer readings, and LOD.
